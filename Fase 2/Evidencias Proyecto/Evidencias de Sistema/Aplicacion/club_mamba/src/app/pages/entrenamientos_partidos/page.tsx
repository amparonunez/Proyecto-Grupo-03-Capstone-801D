  ...
  const eventos = [
    {
      ...
      descripcion: "Sesión de técnica y resistencia enfocada en defensa y pases.",
    ...
    },
    {
      ...
      descripcion: "Partido amistoso contra el Club Andes. Se requiere puntualidad.",
  ...
  useEffect(() => {
    const fetchUserRole = async () => {
      ...
      if (res.ok && result.rol) {
        ...
        console.error(result.error || "No se pudo obtener el rol.");
      }
    };
        ...
        <main className="flex flex-col items-center py-16 flex-grow">
            ...
            <div className="grid grid-cols-2 gap-8">
              {eventos.map((evento, index) => (
                <div
                  ...
                  className="bg-[#1E1E1E] p-6 rounded-2xl border border-gray-700 hover:border-yellow-400 hover:scale-105 transition-all cursor-pointer"
                >
          ...
          {rol === "entrenador" && (
            <div className="flex justify-center mt-10">
              <Link
                href="/crear_partido_entrenamiento"
